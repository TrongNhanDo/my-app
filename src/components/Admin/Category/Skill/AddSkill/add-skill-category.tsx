      ...
      <form onSubmit={formikBag.handleSubmit} className="div-contai">
        <div className="div-register">
          ...
          <div className="mb-6">
            ...
            />
            {formikBag.errors.skillId && formikBag.touched.skillId && (
              <p className="text-orange-600">{formikBag.errors.skillId}</p>
            )}
          </div>
          <div className="mb-6">
            <Input
              ...
              id="skillName"
              className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-1 ${
                formikBag.errors.skillName && formikBag.touched.skillName
                  ? 'bg-yellow'
                  : ''
              }`}
              onChange={formikBag.handleChange}
            ...
            />
            {formikBag.errors.skillName && formikBag.touched.skillName && (
              <p className="text-orange-600">{formikBag.errors.skillName}</p>
            )}
          </div>
