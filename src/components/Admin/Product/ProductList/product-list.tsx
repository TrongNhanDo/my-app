    ...
    <div className="div-contai mb-10">
      ...
      <div>
        ...
        <div className="flex justify-center mb-2">
          ...
          {modal && (
            <ModalCustom>
              <form onSubmit={formikBag.handleSubmit} className="width-70vh">
                    ...
                    {viewData &&
                      ...
                      viewData.ageCategory.map(
                        (value: AgeType, index: number) => {
                          return (
                            <option key={index} value={value.ageId}>
                              {value.ageName}
                            </option>
                          );
                        }
                    ...
                    {viewData &&
                      ...
                      viewData.branchCategory.map(
                        (value: BranchType, index: number) => {
                          return (
                            <option key={index} value={value.branchId}>
                              {value.branchName}
                            </option>
                          );
                        }
                    ...
                    {viewData &&
                      ...
                      viewData.skillCategory.map(
                        (value: SkillType, index: number) => {
                          return (
                            <option key={index} value={value.skillId}>
                              {value.skillName}
                            </option>
                          );
                        }
                ...
                <div className="mt-3">
                  <label htmlFor="productName">
                    ...
                    <input
                      ...
                      className={`ms-5 ${
                        formikBag.errors.images && formikBag.touched.images
                          ? 'bg-yellow'
                          : ''
                      }`}
                    />
                  ...
                  {formikBag.errors.images && formikBag.touched.images && (
                    <p className="text-orange-600">{formikBag.errors.images}</p>
                  )}
                  {ListImage && <div className="mt-3">{ListImage()}</div>}
                </div>
                <div className="mt-3 text-base">
                  ...
                  <input
                    ...
                    className={`bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-base ${
                      formikBag.errors.price && formikBag.touched.price
                        ? 'bg-yellow'
                        : ''
                    }`}
                    onChange={formikBag.handleChange}
                  />
                  {formikBag.errors.price && formikBag.touched.price && (
                    <p className="text-orange-600">{formikBag.errors.price}</p>
                  )}
                </div>
                <div className="text-base mt-3">
                  ...
                  <input
                    ...
                    className={`bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-base ${
                      formikBag.errors.amount && formikBag.touched.amount
                        ? 'bg-yellow'
                        : ''
                    }`}
                    onChange={formikBag.handleChange}
                  />
                  {formikBag.errors.amount && formikBag.touched.amount && (
                    <p className="text-orange-600">{formikBag.errors.amount}</p>
                  )}
                </div>
                <div className="text-base mt-3">
                  ...
                  <textarea
                    ...
                    className={`bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-base ${
                      formikBag.errors.describes && formikBag.touched.describes
                        ? 'bg-yellow'
                        : ''
                    }`}
                    onChange={formikBag.handleChange}
        ...
        <div className="overflow-x-auto shadow-md sm:rounded-lg">
          <table className="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
              {data &&
                data.products &&
                data.products.map((value: ProductType, index: number) => (
                  <tr
                    key={index}
                    className="bg-white border-b hover:bg-gray-100 text-black"
                  >
                    <td className="px-6 py-4">{index + 1}</td>
                    <td className="px-6 py-4">{value.productName || ''}</td>
                    ...
                    <td className="px-6 py-4 w-1/6">
                      <img
                        ...
                        alt={value.images ? value.images[0] : DEFAULT_IMAGE}
                      />
                    </td>
