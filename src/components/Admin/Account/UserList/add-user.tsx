      ...
      <form onSubmit={formikBag.handleSubmit} className="div-contai">
        <div className="div-register">
          ...
          <div className="mb-6">
            ...
            />
            {formikBag.errors.username && formikBag.touched.username && (
              <p className="text-orange-600">{formikBag.errors.username}</p>
            )}
          </div>
          <div className="mb-6">
            <Input
            ...
            {formikBag.errors.password && formikBag.touched.password && (
              <p className="text-orange-600">{formikBag.errors.password}</p>
            )}
          </div>
          <div className="mb-6">
            <Input
            ...
            {formikBag.errors.confirmPwd && formikBag.touched.confirmPwd && (
              <p className="text-orange-600">{formikBag.errors.confirmPwd}</p>
            )}
          </div>
          <div className="mb-6">
            <select
            ...
            {formikBag.errors.roleId && formikBag.touched.roleId && (
              <p className="text-orange-600">{formikBag.errors.roleId}</p>
            )}
          </div>
