...
export const Footer = () => {
   ...
   return (
      <footer className="bg-gray-300 footer">
         {!isAdmin ? (
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
               ...
               <div className="sm:flex sm:items-center sm:justify-between text-black">
                  <span className="text-sm sm:text-center dark:text-gray-400 font-bold flex">
                     <div className="">
            ...
            <div className="flex justify-center p-4 text-base text-black font-bold">
               <div className="">
                  <span className="sm:text-center dark:text-gray-400">
                     © 2023{" "}
